...
from sqlalchemy import CheckConstraint, DateTime, JSON, String, UniqueConstraint, Uuid
...
class EventProcessingReceipt(Base):
    ...
    __table_args__ = (UniqueConstraint("consumer", "message_id", name="uq_receipt_consumer_message"),)
