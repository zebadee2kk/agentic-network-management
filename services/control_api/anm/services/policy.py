...
from anm.schemas import PolicyDecision
...
class PolicyClient:
    ...
    async def evaluate_action(self, input_document: dict[str, Any]) -> PolicyDecision:
        ...
        try:
            async with httpx.AsyncClient(timeout=self._timeout) as client:
                ...
                return PolicyDecision.model_validate({**result, "source": "opa"})
